...
class Solution:
    ...
    def ladder_length(self, start: str, end: str, word_dict: Set[str]) -> int:
        ...
        while forward_q and backward_q:
            distance += 1
            if self.probe_next_level(forward_q, forward_visited, backward_visited, graph):
                return distance
            
            distance += 1
            if self.probe_next_level(backward_q, backward_visited, forward_visited, graph):
                return distance
    ...
    def probe_next_level(self, q, visited, opposite_visited, graph):
